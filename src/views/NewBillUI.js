            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <p class="file-input-error-message hide" data-testid="file-input-error-message">Ce fichier n'est pas supporté, veuillez choisir un fichier jpeg, jpg, ou png.</p>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="submit-new-bill-btn" class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
